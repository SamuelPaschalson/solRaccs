    ...
    <nav className=" border-gray-200">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-8 mx-auto">
        ...
        <a href="#" className="flex items-center">
          <img src={Logo} className="h-20 mr-3 sm:h-25" alt="Landwind Logo" />
        </a>

        {/* Right side - Download button and mobile menu toggle */}
        <div className="flex items-center lg:order-2">
          ...
          <div className="relative inline-block rounded-[8px]">
            <a className="bg-gradient-to-r from-[#fd6e6a] cursor-pointer to-[#ffc600] text-white font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 rounded-md transition-colors duration-300 hover:bg-transparent">
              Get Started
            </a>
          </div>
